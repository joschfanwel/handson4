...
public class DoWhileLoopPractice {
    public static void main(String[] args) {
        ...
        // Your code here:
        do{
            System.out.println("This runs once even when condition is false");
        }while(condition);
        ...
        do{
            if(text.charAt(charIndex) == target){
                System.out.println("'a' found at index: " + charIndex);
                break;
            }
            charIndex++;
        ...
        do{
            ...
            enteredPassword = (attemptCount == 1) ? "secret123" : "wrong";
        ...
        // Your code here:
        do{
            System.out.println("Complete level " + currentLevel);
            currentLevel++;
